...
const TransactionHistory = () => {
  const transactions = [
    { icon: incomeIcon, type: "Monthly Subscription", date: "14 Aug, 2022", amount: "# 10,000", isIncome: true },
    { icon: expenseIcon, type: "Wallet Top-Up", date: "14 Aug, 2022", amount: "# 30,000", isIncome: false },
  ...
  return (
    <div className="mt-8 p-4 shadow-md">
      ...
      <h2 className="text-lg font-bold">{windowWidth >= 768 ? "Transaction History" : "History"}</h2>
        ...
        {transactions.map((transaction, index) => (
          ...
          >
            <div className="flex-shrink-0">
              <img src={transaction.icon} alt={transaction.type} className="w-8 h-8" />
            </div>
